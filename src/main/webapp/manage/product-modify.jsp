...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改商品</h2>
		<div class="manage">
			<form action="${pageContext.request.contextPath}/product/update/${product.epId}" enctype="multipart/form-data" method="post">
				<table class="form">
					<tr>
					...
					<tr>
					  ...
					  <td><input name="epDescription" value="${product.epDescription}" type="text" class="text" id="productDescription" /></td>
				  </tr>
					<tr>
						<td class="field">所属分类：</td>
						<td>
							<select name="epcId" >
								<option value="545" selected>生活用品</option>
					...
					<tr>
						...
						<td><input type="text" value="${product.epPrice}" class="text tiny" name="epPrice" /> 元</td>
					</tr>
					<tr>
						<td class="field">库存：</td>
						<td><input type="text" value="${product.epStock}" class="text tiny" name="epStock" id="productStock" /></td>
					</tr>
					<tr>
