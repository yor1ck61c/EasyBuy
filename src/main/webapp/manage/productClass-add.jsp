...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加分类</h2>
		<div class="manage">
			<form action="${pageContext.request.contextPath}/productCategory/insert" method="post">
				<table class="form">
					<tr>
					...
					<tr>
						<td></td>
						<td><label class="ui-blue" style="margin-left: 100px"><input type="submit" name="submit" value="添加" /></label></td>
					</tr>
				</table>
			</form>
		</div>
