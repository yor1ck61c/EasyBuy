...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="${pageContext.request.contextPath}/comment/replyInfo" method="post">
				<table class="form">
					<tr>
					...
					<tr>
						...
						<td><input name="ecNickName" type="text" class="text" value="${comment.ecNickName}" readonly="readonly" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td ><label style="margin-left: 150px" class="ui-blue"><input type="submit" name="submit" value="回复" /></label></td>
					</tr>
				</table>
			</form>
		</div>
